...
const options = [
  ...
  { icon: 'image', label: 'Pet Photos & Videos', detail: 'Synced with Pet Photos' },
  ...
  { icon: 'cloud', label: 'Pet Shop Orders', detail: 'Synced with Pet Shop Account' },
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.switchContainer}>
        ...
        <Switch
          ...
          onValueChange={() => setIsBackupEnabled(previousState => !previousState)}
        />
      </View>
      ...
      <Text style={styles.infoText}>Pawsitive backs up automatically over Wi-Fi after it's been idle and charging for 2 hours</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.option}>
            <Ionicons name={item.icon} size={24} color="#000" style={styles.optionIcon} />
